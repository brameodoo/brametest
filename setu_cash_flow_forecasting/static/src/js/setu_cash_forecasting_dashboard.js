...
//import { Component, useExternalListener, useEffect, useRef, onMounted,onWillStart,useState } from "@odoo/owl";
...
//                                    },
                                ...
                                title: {
                                    display: true,
                                    text: 'Value (' + this.dashboardData[12] + ')',
                                },
                            },
                            x: {
                                grid: {
                    ...
                    tooltip: {
                        callbacks: {
                            label: function(tooltipItem) {
                                ...
                                return " " + display_data[tooltipItem.dataIndex];
                            }
                        }
                    },
                },
