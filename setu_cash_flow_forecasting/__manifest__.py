...
# Part of Odoo. See LICENSE file for full copyright and licensing details.
{
    ...
    'data': [
        ...
        'wizard/setu_budget_forecasting_installation_wizard.xml',
    ...
    'assets': {
        'web.assets_backend': [
            # 'addons/web/static/src/legacy/js/libs/jquery.js',
            ...
            'setu_cash_flow_forecasting/static/src/js/pivot.xml',
